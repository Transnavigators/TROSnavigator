...
htmlhelp_basename = 'TROSnavigatordoc'
...
latex_documents = [
    (master_doc, 'TROSnavigator.tex', 'TROSnavigator Documentation',
     'Anthony Donaldson and Matthew Yuen', 'manual'),
]
...
man_pages = [
    (master_doc, 'trosnavigator', 'TROSnavigator Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TROSnavigator', 'TROSnavigator Documentation',
     author, 'TROSnavigator', 'One line description of project.',
     'Miscellaneous'),
]
